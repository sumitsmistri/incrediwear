...
function Slide_07() {
  ...
  /* const audio = useAudio("/slides/07/s07.mp3", {
    volume: 1,
    playbackRate: 1,
    loop: false,
  }); */
  ...
  return (
    ...
    >
      <Helmet>
        <meta charSet="utf-8" />
        <title>Incrediwear Interactive - 07</title>
      </Helmet>
      {slideData.bg ? (
        <motion.main style={Styles.slide} className={`slidePage slidePage page_7`}>
          <div className={`container bg-none slider-7`}>
            ...
            >
              <span className="jsx-456089764 text size-l color-standard">
                <em className="size-xl">Today,</em> you&apos;ll learn
                <br /> about a <em>revolutionay</em> <br />
                product that <em>EVERY</em> <br />
